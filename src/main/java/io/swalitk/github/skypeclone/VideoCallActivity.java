...
public class VideoCallActivity extends AppCompatActivity {
    ...
    private final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onJoinChannelSuccess(String channel, final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.e("myKey","Join channel success, uid: " + (uid & 0xFFFFFFFFL));
                }
            });
        }
        ...
        public void onUserJoined(final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.d("mykey","First remote video decoded, uid: " + (uid & 0xFFFFFFFFL));
        ...
        public void onUserOffline(final int uid, int reason) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.d("myKey","User offline, uid: " + (uid & 0xFFFFFFFFL));
    ...
    private void showSampleLogs() {
        Log.e("myKey","Welcome to Agora 1v1 video call");
        Log.e("myKey","You will see custom logs here");
        Log.e("myKey","You can also use this to show errors");
    }
